                        ...
                        <div class="booking-form-wrap">
                            <div class="row">
                                <div class="col-lg-7 col-12 p-0">
                                    <form class="custom-form booking-form" method="POST" action="index.php?action=signin" role="form">
                                        <div class="text-center mb-4 pb-lg-2">
                                            <em class="text-white">Fill out the form to sign in</em>

                                            <h2 class="text-white">sign in to your account</h2>
                                        </div>
                                        <div class="text-center mb-4 pb-lg-2">
                                            <?php if (isset($error)) : ?>
                                        ...
                                        <div class="booking-form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-12">
                                                    <input type="password" name="login-form-password" id="login-form-password" class="form-control" placeholder="Password" required>
                                                </div>
